    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-card/80 backdrop-blur-md px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <Avatar name={user?.name || "User"} size="sm" className="ring-2 ring-indigo-500/20" />
          ...
          {/* Dropdown Menu */}
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 rounded-xl border border-border bg-card shadow-xl shadow-indigo-500/10 py-1.5 animate-in fade-in zoom-in-95 duration-200">
