...
const SCORE_TYPE_COLOR: Record<string, string> = {
  Tugas: "bg-blue-100 text-blue-700 border-blue-200",
  UTS: "bg-amber-100 text-amber-700 border-amber-200",
  UAS: "bg-red-100 text-red-700 border-red-200",
  Kuis: "bg-purple-100 text-purple-700 border-purple-200",
};
                ...
                <Card key={idx} className="overflow-hidden border-border">
                  ...
                  <div className="flex items-center justify-between px-6 py-4 bg-muted/40 border-b border-border">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-bold text-foreground">{subject.subject}</h3>
                    </div>
