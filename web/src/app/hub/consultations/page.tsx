  ...
  return (
    <div className="space-y-6 h-[calc(100vh-120px)] flex flex-col">
      <div className="flex items-center justify-between shrink-0">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Konsultasi Wali Murid</h1>
      ...
      <div className="flex gap-6 flex-1 min-h-0">
        <Card className="w-1/3 flex flex-col min-h-0 border-border">
          <div className="p-4 border-b border-border bg-muted/30">
            <h3 className="font-bold">Kotak Masuk</h3>
          </div>
          ...
          {selectedThread ? (
            <>
              <div className="p-4 border-b border-border bg-muted/30 shrink-0">
                <h3 className="font-bold text-lg">{selectedThread.subject}</h3>
