              ...
              <Card
                ...
                className={cn(
                  ...
                  isTeacher
                    ...
                    : isSubmitted
                    ? "hover:border-emerald-300 border-l-4 border-l-emerald-500"
                    : isOverdue
                    ...
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 space-y-2.5 min-w-0">
                        ...
                        <div className="flex items-start flex-wrap gap-2 gap-y-1.5">
                          <h3 className="font-bold text-base leading-tight text-foreground break-words flex-1">
                            {assignment.title}
                          </h3>
                          ...
                          {!isTeacher && !isSubmitted && !isOverdue && (
                            <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2.5 py-1 rounded-full bg-amber-100 text-amber-700 border border-amber-200 shadow-sm flex-shrink-0">
                        ...
                        {!isTeacher && isSubmitted && submissionData && (
                          <div className="mt-3 p-3 rounded-lg bg-emerald-50 border border-emerald-200">
                            ...
                            {submissionData.content && (
                              <p className="text-xs text-emerald-800 line-clamp-2 mb-1">
                                {submissionData.content}
                              </p>
                            )}
                              ...
                              <div className="flex items-center gap-1.5 text-xs text-emerald-700">
                                ...
                                {submissionData.fileUrl && (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="ml-1 text-indigo-600 hover:underline flex items-center gap-0.5"
                                  >
              ...
              <div className="p-4 rounded-xl bg-indigo-50 border border-indigo-200">
                ...
                {selectedAssignment.fileUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 mt-2 text-xs text-indigo-600 hover:underline font-medium"
                  >
            ...
            <div className="space-y-2">
              ...
              {!submissionFile && !submissionFilePreview ? (
                <button
                  ...
                  className="w-full border-2 border-dashed border-indigo-300 rounded-xl p-8 flex flex-col items-center gap-3 text-indigo-500 hover:border-indigo-500 hover:bg-indigo-50 transition-all duration-200 cursor-pointer"
                >
                  <Upload size={32} />
                ...
                <div className="flex items-center justify-between p-3 rounded-xl border border-emerald-200 bg-emerald-50">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-bold text-emerald-800 truncate max-w-[250px]">
