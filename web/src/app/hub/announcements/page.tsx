    ...
    <div className="space-y-6">
      ...
      {loading ? (
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg ${
                      ...
                      ann.priority === 'important' ? 'bg-amber-50 text-amber-600' : 'bg-indigo-50 text-indigo-600'
                    }`}>
                      <Megaphone size={20} />
                    </div>
                    <div>
                  ...
                  {ann.priority !== 'normal' && (
                    <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded ${
                      ann.priority === 'urgent' ? 'bg-rose-100 text-rose-700' : 'bg-amber-100 text-amber-700'
                    }`}>
                      {ann.priority}
                    </span>
                  )}
        ...
        <div className="py-20 text-center border-2 border-dashed border-border rounded-3xl bg-card">
          ...
          <h3 className="text-lg font-bold text-foreground">Belum Ada Pengumuman</h3>
      ...
      <div className="p-4 rounded-xl bg-indigo-50 border border-indigo-100 flex items-start gap-3 text-indigo-700 text-sm">
