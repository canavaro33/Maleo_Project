            ...
            <tbody className="divide-y divide-border">
              {loading ? (
                ...
                <tr key={p.id} className="hover:bg-muted/10 transition-colors">
                  ...
                  <td className="px-6 py-4 font-mono text-xs text-indigo-600 font-bold">{p.principalCode}</td>
                  ...
                  <td className="px-6 py-4 text-right space-x-1">
                    <Button variant="ghost" size="sm" onClick={() => openEdit(p)} className="text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50" title="Edit">
                      <Pencil size={18} />
                    </Button>
                    <Button variant="ghost" size="sm" title="Reset Password" onClick={() => handleResetPassword(p.id, p.principalCode)} className="text-amber-600 hover:text-amber-700 hover:bg-amber-50">
                      <ShieldCheck size={18} />
                    </Button>
